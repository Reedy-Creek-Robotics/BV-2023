...
public class autoRedSide extends LinearOpMode {
    ...
    elementLocation spikeLocation = autoRedSide.elementLocation.RIGHT;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            telemetry.update();
            motorAction(0.6, 6, autoRedSide.Direction.FORWARD, false);
            sleep(10000);

            /*if (redDetection == 0) {
                motorAction(0.6, 6, autoRedSide.Direction.RIGHT, false);
            } else if (redDetection == 1) {
                motorAction(0.6, 6, autoRedSide.Direction.LEFT, false);
    ...
    public int webCamActivateRed() {
        ...
        redProcessor = new OpenCvPipeline() {
            ...
            public Mat processFrame(Mat input) {
                ...
                autoRedSide.this.contoursRed = contours;
        ...
        List<MatOfPoint> contoursRed = autoRedSide.this.contoursRed;
        ...
        for (int i = 0; i < contoursRed.size(); i++) {
            ...
            if (Math.abs(Imgproc.contourArea(contoursRed.get(i))) > contourMinimum) {
                ...
                if (rect1.contains(contourCent)) {
                    spikeLocation = autoRedSide.elementLocation.LEFT;
                } else if (rect2.contains(contourCent)) {
                    spikeLocation = autoRedSide.elementLocation.MIDDLE;
                }
            } else {
        ...
        if (spikeLocation == autoRedSide.elementLocation.RIGHT) {
            elementLocation = 0;
        } else if (spikeLocation == autoRedSide.elementLocation.LEFT) {
            elementLocation = 1;
        } else if (spikeLocation == autoRedSide.elementLocation.MIDDLE) {
            elementLocation = 2;
        }
    ...
    /*public int webCamActivateBlue() {
        ...
        OpenCvPipeline blueProcessor = new OpenCvPipeline() {
            ...
            public Mat processFrame(Mat input) {
                ...
                autoRedSide.this.contoursBlue = contours;
        ...
        waitForStart();
            ...
            List<MatOfPoint> contoursBlue = autoRedSide.this.contoursBlue;
