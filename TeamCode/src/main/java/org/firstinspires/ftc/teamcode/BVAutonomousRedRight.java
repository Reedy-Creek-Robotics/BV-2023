...
@Autonomous
public class BVAutonomousRedRight extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            motorAction(1, 12, Direction.RIGHT, false);
    ...
    public elementLocation webCamActivateRed() {
        ...
        redProcessor = new OpenCvPipeline() {
            ...
            public Mat processFrame(Mat input) {
                ...
                BVAutonomousRedRight.this.contoursRed = contours;
        ...
        List<MatOfPoint> contoursRed = BVAutonomousRedRight.this.contoursRed;
